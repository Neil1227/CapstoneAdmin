      ...
      <section id="add" class="hero d-flex align-items-center  " style= "padding-top: 0;">
       <div class="container">
              <div class="row">
                  ...
                  <h2><span>Qualified</span>  Records </h2>
                  <div class="row mt-3">
                ...
                <?php
                  ...
                  $sql = "SELECT * FROM qualified_table";
                  ...
                  while ($row = $result->fetch_assoc()) {
                      ...
                      <td>{$row['schedule']}</td>
                          ...
                          <i class='bi bi-person-bounding-box'></i>
                              ...
                              <a class='btn btn-outline-danger qual-delete-button' href='#' data-bs-toggle='modal' data-bs-target='#deleteAppQualModal' 
                              data-id=' {$row['id']};' 
...
$(document).ready(function() {
    var table = $('#table-show').DataTable({
        ...
        "paging": true,
        "aoColumnDefs": [
            { "bSortable": false, "aTargets": [5, 7,8,9] } // Disable sorting for columns 1 and onwards
        ]
    });
